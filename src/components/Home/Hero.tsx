    ...
    <>
      <div className="min-h-[70vh] flex flex-col mx-8 xl:mx-0 py-24 gap-10 lg:py-0 lg:flex-row justify-evenly items-center">
        <div className="flex flex-col max-w-md gap-6 md:items-start">
          ...
          <div className="font-bold capitalize text-orange-400">
            <span className="text-3xl md:text-3xl">best way to</span>{" "}
            <h2 className="text-4xl md:text-[2.75rem]">buy your dream rv</h2>
          </div>
        ...
        <Image
          className="drop-shadow-[0_35px_35px_rgba(196,126,51,1)] rounded-xl"
          priority={true}
          src="/car.png"
          width={500}
          height={500}
      ...
      <div className="bg-[#dae3f6]/40 drop-shadow-[0_20px_35px_rgba(196,126,51,1)] p-16">
